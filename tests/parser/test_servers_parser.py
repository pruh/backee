...
class LoggersParserTestCase(ConfigMixin, unittest.TestCase):
    ...
    def test_servers_all_values_parsed(self):
        ...
        """
        expected_server = self.__create_ssh_backup_server(
            name="server 1",
            location="/some/path1",
            hostname="hostname1",
            port=2222,
        ...
        self.assertEqual(
            expected_server, parsed_server, msg="full server is not correct"
        )
    ...
    def test_servers_default_values_parsed(self):
        ...
        """
        expected_server = self.__create_ssh_backup_server(
            name="server 2", location="/some/path2", hostname="hostname2"
        )
    ...
    def __create_ssh_backup_server(
        self,
        name: str,
        location: str,
        hostname: str,
        ...
        username: str = None,
        key_path: str = None,
        rotation_strategy: RotationStrategy = RotationStrategy(
            daily=1, monthly=0, yearly=0
        ),
    ) -> SshBackupServer:
